...
public class Banking
{
   ...
   public static void main (String[] args)
   {
      ...
      Account acct4 = new Account ("Odelia Lorch", 12345);
      ...
      Account.transfer(acct1, acct2, 30.0); 
      System.out.println("Murphy balace after transfer: " + acct1.getBalance());
      System.out.println("Gomez balance after transfer: " + acct2.getBalance()); 
